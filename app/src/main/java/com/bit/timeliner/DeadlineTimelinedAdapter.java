...
public class DeadlineTimelinedAdapter extends RecyclerView.Adapter<DeadlineTimelinedAdapter.ViewHolder> {
...
//    }
    ...
    @NonNull
    @Override
    public DeadlineTimelinedAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_deadline_timelined, parent, false);
        return new ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull DeadlineTimelinedAdapter.ViewHolder holder, int position) {
...
//        });
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            deadlineTitle = itemView.findViewById(R.id.tvTitleTl);
            deadlineDate = itemView.findViewById(R.id.tvDetailsTl);
        }
    }
